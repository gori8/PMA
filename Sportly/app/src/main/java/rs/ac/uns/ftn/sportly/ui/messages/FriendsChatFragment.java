...
public class FriendsChatFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mMainView = inflater.inflate(R.layout.fragment_chat_friends, container, false);

        mFriendsList = (RecyclerView) mMainView.findViewById(R.id.friends_chat_list);

        mCurrent_user_id = JwtTokenUtils.getUserId(getActivity()).toString();
